    ...
    public class ValidationsMethodPost
    {
        ...
        public ValidationsMethodPost ValidationsMethodPostDoctor(MedicoCustom oDoctor)
        {
            ...
            try
            {
                ...
                if (repoDoctor.VerifyIfDoctorExist(oDoctor.Nombre, oDoctor.Dni)) throw new ArgumentException("El Médico ya existe.");
        ...
        public ValidationsMethodPost ValidationsMethodPostPatient(Paciente oPatient)
        {
            ...
            try
            {
                ...
                #region Validaciones de existencia
                if (repoPatient.VerifyIfPatientExist(oPatient.Nombre, oPatient.Dni)) throw new ArgumentException("El Paciente ya existe.");
